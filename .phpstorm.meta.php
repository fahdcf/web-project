...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/mohssine/Desktop/web_project/web-project/public/storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/mohssine/Desktop/web_project/web-project/public/storage','ide-helper.filename','ide-helper.models_filename',
...
'broadcasting.connections.ably.key','broadcasting.connections.log.driver','broadcasting.connections.null.driver','migrations-generator.migration_template_path','migrations-generator.migration_target_path',
'migrations-generator.filename_pattern.table','migrations-generator.filename_pattern.view','migrations-generator.filename_pattern.procedure','migrations-generator.filename_pattern.foreign_key','tinker.commands',
'tinker.alias','tinker.dont_alias',);
        registerArgumentsSet('middleware', 
'web','api',);
        registerArgumentsSet('routes', 'coordinator.modules','coordinator.assign','coordinator.assign.store','coordinator.validate','login','pendinguser','reset','departements.list','filieres.list','profile.edit','pending_users','notifications.read','storage.local',);
        registerArgumentsSet('views', 
'admin.add_admin','admin.add_department','admin.add_etudiant','admin.add_filiere','admin.add_professeur',
'admin.admin_dashboard','admin.admin_profile','admin.admin_user_profile','admin.admins','admin.admins_list',
'admin.departments','admin.etudiants','admin.filieres','admin.modify_admins','admin.modify_etudiants',
'admin.modify_professeurs','admin.oldadmin_profile','admin.pending_users','admin.professeurs','admin.testpage',
'components.admin_layout','components.admin_layout2','components.coordonnateur_layout','components.layout','components.pendinguser_layout',
'coordonnateur.assign','coordonnateur.dashboard','coordonnateur.modules','dashboard','emails.newuser',
'emails.resetpassword','login','oldsignup','other_profile','password_reset',
'pending_user.pendinguser','signup','user_profile','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context',
