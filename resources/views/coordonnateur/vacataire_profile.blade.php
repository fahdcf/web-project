<x-coordonnateur_layout>
    <div class="container-fluid py-5">
        ...
        <div class="profile-container">
            ...
            <div class="hours-progress-container mb-4">
                ...
                <div class="progress-bar-container">
                    <div class="progress-bar-background">
                        ...
                        <div class="min-marker"
                            style="left: {{ $min_marker_pos }}%; background-color: {{ $min_marker_pos <= $progress_percentage ? 'rgba(255, 255, 255, 0.462);' : 'rgba(226, 21, 21, 0.582);' }}">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="info-grid">
                        ...
                        @if (auth()->user()->role->iscoordonnateur)
                            <div class="info-item">
                                ...
                                <input type="number" class="editable-field" name="min_hours"
                                    value="{{ $user->user_details->min_hours ?? '' }}">
                            </div>

                            <div class="info-item">
                                <div class="info-label">Max Hours</div>
                                <input type="number" class="editable-field" name="max_hours"
                                    value="{{ $user->user_details->max_hours ?? '' }}">
                            </div>
            ...
            <div id="assigned-modules" class="tab-content active">
                @if ($assignement->count() > 0)
                    <div class="module-grid-container">
                        <div class="module-grid">
                            @foreach ($assignement as $assign)
                                <div class="module-card">
                                    <div class="module-header">
                                        <div class="module-title-container">
                                            <h3 class="module-name">{{ $assign->module->name }}</h3>
                                            <div class="module-hours-badge">{{ $assign->module->type }}</div>
                                        </div>
                                        <div class="module-workload">
                                            @if ($assign->teach_cm)
                                                <div class="workload-item">
                                                    ...
                                                    <span
                                                        class="workload-value">{{ $assign->module->cm_hours }}h</span>
                                                </div>
                                            @endif
                                            ...
                                            @if ($assign->teach_td)
                                                <div class="workload-item">
                                                    ...
                                                    <span
                                                        class="workload-value">{{ $assign->module->td_hours }}h</span>
                                                </div>
                                            @endif
                                            ...
                                            @if ($assign->teach_tp)
                                                <div class="workload-item">
                                                    ...
                                                    <span
                                                        class="workload-value">{{ $assign->module->tp_hours }}h</span>
                                                </div>
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <div class="module-details">
                                        <div class="detail-item">
                                            ...
                                            <div>
                                                ...
                                                <span
                                                    class="detail-value">{{ $assign->module->semester->name ?? 'N/A' }}</span>
                                            </div>
                                        </div>
                                        <div class="detail-item">
                                            ...
                                            <div>
                                                ...
                                                <span class="detail-value">{{ $assign->module->semester }}</span>
                                            </div>
                                        </div>
                                    </div>

                                    <div class="module-actions">
                                        <button class="remove-btn" data-toggle="modal"
                                            data-target="#removemoduleId{{ $assign->id }}">
                                ...
                                <!-- Remove Modal -->
                                <div class="modal fade" id="removemoduleId{{ $assign->id }}" tabindex="-1"
                                    role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel"
                                                    style="color:#333; font-weight:500">Remove module</h5>
                                            ...
                                            <div class="modal-body">
                                                <p style="color: #585858">Vous voulez remover le module
                                                ...
                                                <form action="{{ url('/chef/professeurs/remove/' . $assign->id) }}"
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn ml-1 btn-secondary btn-sm"
                                                            data-dismiss="modal">Close</button>
                                                        <button type="submit"
                                                            class="btn ml-1 btn-danger btn-sm">Remove</button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
                ...
                @else
                    <div class="empty-state">
                        ...
                        <p>No modules assigned to this vacataire</p>
                    </div>
                @endif
            </div>
            ...
            <div id="available-modules" class="tab-content">
                <div class="module-filters">
                    <div class="semester-item">
                        <label for="semester-filter" class="semester-label">Filter by Semester</label>
                        <select id="semester-filter" onchange="filterModules()">
                    ...
                    <div class="semester-item">
                        <label for="name-search" class="semester-label">Search by Name</label>
                        <input type="text" id="name-search" placeholder="Enter module name"
                ...
                <form id="assign-modules-form" method="POST" action="{{ route('coordonnateur.vacataire.affecterModules') }}">
                    ...
                    <div class="drop-area " ondragover="allowDrop(event)" ondrop="dropModule(event)">
                        ...
                        <button type="submit" class="savee-btn mt-3"><i class="bi bi-check-square"></i></button>
                        <p>Drop Here</p>
                ...
                <div class="module-grid-container">
                    <div class="module-grid" id="available-modules-grid">
                        @foreach ($available_modules as $module)
                            <div class="module-card" draggable="true" data-module-id="{{ $module->id }}"
                                ...
                                <div class="module-details">
                                    <div class="detail-item">
                                        ...
                                        <div>
                                            <span class="detail-label">Filière</span>
                                            <span
                                                class="detail-value">{{ $module->filiere ? $module->filiere->name : 'N/A' }}</span>
                                        </div>
                                    </div>
                                    <div class="detail-item">
                                        <i class="bi bi-calendar-week detail-icon"></i>
                ...
                <!-- Teaching Type Modal -->
                <div class="modal fade" id="teachingTypeModal" tabindex="-1" role="dialog"
                    aria-labelledby="teachingTypeModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="teachingTypeModalLabel"
                                    style="color:#333; font-weight:500">Select Teaching Types</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">×</span>
                                </button>
                            </div>
                            <div class="modal-body">
                                <p style="color: #585858">Select the teaching types for <strong
                                        id="modal-module-name"></strong>:</p>
                                <div class="teaching-type-options">
                                    <label><input type="checkbox" name="teaching_types" value="cm"
                                            class="teaching-type-checkbox"> CM (Cours Magistraux)</label>
                                    <label><input type="checkbox" name="teaching_types" value="td"
                                            class="teaching-type-checkbox"> TD (Travaux Dirigés)</label>
                                    <label><input type="checkbox" name="teaching_types" value="tp"
                                            class="teaching-type-checkbox"> TP (Travaux Pratiques)</label>
                                    <label><input type="checkbox" name="teaching_types" value="all"
                                            id="all-teaching-type" onchange="toggleAllTeachingTypes()"> All</label>
                                </div>
                            </div>
                            <div class="modal-footer">
                                ...
                                <button type="button" class="btn btn-primary btn-sm"
                                    onclick="confirmTeachingTypes()">Confirm</button>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        function filterModules() {
            ...
            moduleCards.forEach(card => {
                const semester = card.querySelector('.detail-value').textContent;
    ...
    <style>
        ...
        .min-marker {
            ...
            /* White with 70% opacity, overridden by inline style */
        }
        ...
        .max-marker::after {
            ...
            /* Center the marker */
            bottom: -6px;
            /* Position below bar for min */
            width: 12px;
            /* Larger for visibility */
            height: 12px;
            border-radius: 50%;
            background-color: #ffffff;
            모델: border: 2px solid #333333;
        }

        .max-marker::after {
            bottom: auto;
            top: -6px;
            /* Position above bar for max */
        }
