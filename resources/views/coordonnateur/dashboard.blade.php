    ...
    <div class="container-fluid py-4  px-0 d-flex flex-column ">
        <div class="page-wrapper w-100 row m-0">
            ...
            <section class="main-section col-12 col-md-8 col-lg-9 p-0 pr-md-4">
                <div class="welcome p-4 ">
                    <div class="d-flex flex-column justify-content-between col-8">
                        <h3 style="font-weight: 500; padding-bottom: 10px;">{{ auth()->user()->manage->name }}:
                            <strong>{{ auth()->user()->firstname . ' ' . auth()->user()->lastname }}</strong> to the
                            Dashboard
                        </h3>

                        <div class="buttons-wrapper d-flex  gap-3"><button class="addbtn">Ajeuter un utilisateur</button>
                    ...
                    <div class="p-2 col-6 col-lg-3">
                        ...
                        <div class="numbers-card bg-white d-flex  p-2 gap-3 gap-md-4 align-items-center">
                            ...
                            <div class="d-flex flex-column justify-content-start align-items-start">
                                ...
                                <p class="num">Total: <strong>132</strong></p>
                                <button class="seemore">> Voir Plus</button>
            ...
            <section class="side-section col-12 col-md-4 col-lg-3  p-0 pt-4 p-md-0">
                                ...
                                <div class="connection-item">
                                    <div class="connection-profile">
                                        <a href="{{ url('chef/professeur_profile/' . $prof->id) }}">
                                            @if ($prof->user_details && $prof->user_details->profile_img != null)
                                                <img class="profile-img"
                                                    src="{{ asset('storage/' . $prof->user_details->profile_img) }}"
                                        ...
                                        <div class="profile-info">
                                            <a href="{{ url('profile/' . $prof->id) }}"
                                                class="profile-name">{{ $prof->firstname }} {{ $prof->lastname }}</a>
                                            <span
                                                class="connection-time">{{ $prof->created_at->diffForHumans() }}</span>
                                        </div>
                                    </div>
                                    ...
                                    @php
                                        ...
                                        $progress_color =
                                            $current_hours < $min_hours || $current_hours > $max_hours
                                                ? '#EA5455'
                                                : '#28C76F';
                                    ...
                                    <div class="hours-progress">
                                        <div class="hours-info">
                                            ...
                                            <span class="hours-range">{{ $min_hours }}h -
                                                {{ $max_hours }}h</span>
                                        </div>
                                        ...
                                        <div class="progress-track">
                                            ...
                                            <div class="min-marker"
                                                style="left: {{ $min_marker_pos }}%; background-color:{{ $min_marker_pos < $progress_percentage ? 'rgba(79, 231, 137, 0.985)' : 'rgba(210, 77, 53, 0.912)' }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            @foreach ($module_requests as $module_request)
                                <div class="request-card">
                                    <div class="request-main">
                                        <div class="professor-info">
                                            ...
                                            <div class="professor-details">
                                                <h4>{{ $module_request->prof->firstname ?? 'Unknown' }}
                                                    {{ $module_request->prof->lastname ?? 'Professor' }}</h4>
                                                <div class="request-meta">
                                                    <span
                                                        class="module-name">{{ $module_request->target->name ?? 'Not specified' }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="request-id d-flex justify-content-between">
                                        ...
                                        <span
                                            class="request-date">{{ $module_request->created_at->diffForHumans() ?? 'N/A' }}</span>

                                        <div class="dropdown">
                                            <span class="pen-dropdown dropdown-toggle" id="penDropdown"
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="penDropdown">
                                                <li>
                                                    ...
                                                    <form
                                                        action="{{ url('/chef/demandes/' . $module_request['id']) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('DELETE')

                                                        <button class="dropdown-item text-danger" href="#"><i
                                                                class="bi bi-x-circle-fill me-2"></i>Refuser</button>
                                                    </form>
                                                ...
                                                <li>
                                                    <form
                                                        ...
                                                        <button class="dropdown-item text-success"><i
                                                                class="bi bi-check-circle-fill me-2"></i>Accepter</button>
                                                </li>
                                                </form>
                                            </ul>
                                        </div>
                ...
                <div class="tasks-container overflow-hidden shadow-sm mt-4 bg-white"
                    ...
                    <div class="task-content p-3 p-md-4">
                        ...
                        @if (count($tasks) > 0)
                            @foreach ($tasks as $task)
                                <div class="task-item d-flex justify-content-between align-items-center py-3 px-2 mb-2 bg-light"
                                    style="border-radius:15px !important">
                                    <div class="d-flex gap-3 align-items-center">
                                        @if ($task['isdone'])
                                        ...
                                        <div>
                                            <p
                                                class="task-desc m-0 @if ($task['isdone']) text-decoration-line-through text-muted @endif">
                                                {{ $task['description'] }}
                                            </p>
