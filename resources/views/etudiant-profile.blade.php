        ...
        <div class="container-fluid p-0 py-5">
            <div class="profile-container d-flex flex-column">
                ...
                <div class="picture-container mt-5 d-flex align-items-center">
                    ...
                    <img style="height: 80px;width: 80px;object-fit:cover;border-radius:15%; border: 2px solid #1e0a6e;" src="{{asset('storage/' . $user->profile_img)}}">
                    @else
        ...
        <button type="button" class="dangerBtn" data-bs-toggle="modal" data-bs-target="#supprimerModal">Supprimer</button>
                ...
                <div class="col-md-6 col-lg-4 mb-3">
                    <label for="lastname" class="form-label">Nom</label>
                        ...
                        <div class="col-md-6 col-lg-4 mb-3">
                         ...
                         <p class="form-control">{{$filiere_name}}</p>
                        </div>
            ...
            <div class="rounded border p-3">
                <p style="color: #272727; font-weight: 600;">
                    <i class="bi bi-shield-lock"></i> Role : <span style="color: #4723d9">Etudiant</span>
                </p>
                <hr>
        ...
        <section id="informations" class="hidden mt-5">
            ...
            <div class="col-md-6 col-lg-4 mb-3">
                <label for="date" class="form-label">Date de Naissance</label>
                        <input type="date" id="date" name="date" class="form-control" value="{{$user->date_of_birth}}">
                    </div>
    
    
                    <div class="col-md-6 col-lg-4 mb-3">
                        <label for="adresse" class="form-label">Address</label>
                                <input type="text" id="adresse" name="adresse" class="form-control" value="{{$user->adresse}}" placeholder="Votre adress..">
                            </div>
            
                 
                            <div class="col-md-6 col-lg-4 mb-3">
                                <label for="tele" class="form-label">Telephone</label>
                                        <input type="number" id="tele" name="tele" class="form-control" value="{{$user->number}}" placeholder="numero de telephone..">
                                    </div>
                    
                         
                                    <div class="col-md-6 col-lg-4 mb-3">
                                        <label for="cin" class="form-label">CIN</label>
                                                <input type="text" id="cin" name="cin" class="form-control" value="{{$user->CNE}}" placeholder="numero de carte nationale..">
                                            </div>
                                            ...
                                            <div class="col-md-6 col-lg-4 mb-3">
                                                ...
                                                <div class="sex-group d-flex gap-4 mt-1">
                                                    ...
                                                    <label class="sex-label">
                                                      <input type="radio" name="sexe" value="male" class="sex-input" {{$user->sexe ==='male'? 'checked' : ''}} />
                                                      <span class="sex-circle"></span>
                                                      Homme
                                                    </label>
                                                  
                                                    <label class="sex-label">
                                                      <input type="radio" name="sexe" value="female" class="sex-input" {{$user->sexe ==='female'? 'checked' : ''}}/>
                                                      <span class="sex-circle"></span>
                                                      Femme
                                                    </label>
                                                  </div>
