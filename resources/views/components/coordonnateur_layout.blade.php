    ...
    <head>
        ...
        <style>
            ...
            *,
            ...
            /* making the nav bar extend when hovering */
            ...
            <nav class="nav">
                <div>
                    ...
                    <div class="nav_list">
                        ...
                        <a href="{{ url('/') }}"
                            class="nav_link {{ request()->is('coordonnateur') ? 'active' : '' }}">
                        ...
                        @if (auth()->user()->role->isprof)
                            ...
                            <a href="{{ route('emploi.myTimetable') }}"
                                ...
                                <!-- Changed to table icon - represents timetable better -->
                            ...
                            <a href="{{ route('notes_upload_page') }}"
                                ...
                                <!-- Changed to edit icon - more appropriate for "saisir" -->
