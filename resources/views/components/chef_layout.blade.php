            ...
            <div>
                ...
                <div class="nav_list">
                    ...
                    @if (auth()->user()->role->ischef)
                        <a href="{{ url('/chef/modules') }}"
                            class="nav_link {{ request()->is('chef/modules') ? 'active' : '' }}">
                            <i class="bi bi-journal-text"></i>

                            <span class="nav_name">UE</span>
                        </a>

                        <a href="{{ url('/chef/demandes') }}"
                            class="nav_link {{ request()->is('chef/demandes') ? 'active' : '' }}">
                            <i class="bi bi-card-checklist"></i>

                            <span class="nav_name">Demandes</span>
                        </a>

                        <a href="{{ url('/chef/professeurs') }}"
                            class="nav_link {{ request()->is('chef/professeurs') ? 'active' : '' }}">
                        ...
                        <a href="{{ url('/chef/filieres') }}"
                            class="nav_link {{ request()->is('chef/filieres') ? 'active' : '' }}">
                        ...
                        <a href="{{ url('/chef/modules_vacantes') }}"
                            class="nav_link {{ request()->is('chef/modules_vacantes') ? 'active' : '' }}">
                            <i class="bi bi-journal-text"></i>
