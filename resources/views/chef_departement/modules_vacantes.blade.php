<x-chef_layout>
    <div class="container-fluid px-4 pb-5">
        ...
        <div
            ...
            <div>
                <h3 class="mb-2" style="color: #4723d9 ;margin-bottom: 2rem; font-weight: 600;" ><i class="bi bi-card-checklist pr-2"></i>Liste des Modules Vacantes</h3>
            </div>

            <!-- Filière Filter -->
            <div class="dropdown">
                <button class="btn filter-btn dropdown-toggle" type="button" id="filiereFilterDropdown"
                ...
                <ul class="dropdown-menu shadow" aria-labelledby="filiereFilterDropdown">
                    ...
                    @foreach ($filieres as $filiere)
                        <li><a class="dropdown-item" href="#"
                                data-filiere="filiere-{{ $filiere->id }}">{{ $filiere->name }}</a></li>
                    @endforeach
                </ul>
            </div>
        </div>
            ...
            <div class="module-grid">
                ...
                <div class="module-card">
                    ...
                    <div class="module-actions">
                        <button class="affect-btn" onclick="showPopupaff({{$module->id}}, '{{$module->name}}')">
     ...
     <div id="popupfor{{$module->id}}" class="overlay">
        <div class="popup bg-white rounded-3 shadow-lg">
            ...
            <div class="popup-footer">
                <button type="button"  style="background:#4723d9; color: white;" class="btn px-4 rounded-pill" onclick="closePopup({{$module->id}})">
    ...
    <div id="popupforaff{{$module->id}}" class="overlay2">
        <div class="popup bg-white rounded-4 shadow-lg" style="max-width: 500px;">
            ...
            <form action="{{url('chef/modules_vacantes/affecter/'. $module->id)}}" method="post" >
                @csrf
                <div class="d-flex justify-content-between align-items-center mb-4 p-3 border-bottom" style="background-color: #4723d9">
                    <h5 class="text-white fw-bold mb-0" >
                        <i class="bi bi-person-plus me-2"></i>Affecter le module
                    </h5>
                    <button type="button" class="btn btn-sm btn-outline-light" onclick="closePopupaff({{$module->id}})"><i class="bi bi-x-lg"></i></button>
                </div>
                ...
                <!-- Professor Selection -->
                <div class="mb-4">
                    <label for="professor-{{$module->id}}" class="form-label fw-bold text-dark mb-3">
                        <i class="bi bi-person-fill-gear me-2 text-primary"></i>Sélectionner un professeur
                    </label>
                    <select class="form-select py-2 rounded-3 border-primary" id="professor-{{$module->id}}" name="prof_id" required>
                ...
                <div class="mb-4">
                    <label class="form-label fw-bold text-dark mb-3">
                        <i class="bi bi-tags-fill me-2 text-primary"></i>Type d'affectation
                    </label>
                    <div class="row g-3">
                        @if (!$module->ProfCours)
                        <div class="col-6 col-md-4">
                            <div class="form-check card p-3 h-100 border-primary">
                                <input class="form-check-input affectation-type" type="checkbox" id="affectation-cours-{{$module->id}}" name="isCm" value="cm">
                                <label class="form-check-label fw-medium d-block text-center mt-2" for="affectation-cours-{{$module->id}}">
                        ...
                        <div class="col-6 col-md-4">
                            <div class="form-check card p-3 h-100">
                                <input class="form-check-input affectation-type" type="checkbox" id="affectation-tp-{{$module->id}}" name="isTp" value="tp">
                                <label class="form-check-label fw-medium d-block text-center mt-2" for="affectation-tp-{{$module->id}}">
                        ...
                        <div class="col-6 col-md-4">
                            <div class="form-check card p-3 h-100">
                                <input class="form-check-input affectation-type" type="checkbox" id="affectation-td-{{$module->id}}" name="isTd" value="td">
                                <label class="form-check-label fw-medium d-block text-center mt-2" for="affectation-td-{{$module->id}}">
                ...
                <div class="d-flex justify-content-end gap-3 mt-4 pt-3 border-top">
                    <button type="button" class="btn btn-outline-secondary px-4 rounded-pill" onclick="closePopupaff({{$module->id}})">
                        <i class="bi bi-x-lg me-1"></i> Annuler
                    </button>
                    <button type="submit" class="btn px-4 rounded-pill" style="background:#4723d9; color: white;">
