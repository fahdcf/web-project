            ...
            <div class="module-grid">
                ...
                <div class="module-card">
                    ...
                    <div class="module-actions">
                        ...
                        <button class=" affect-btn" onclick="showPopupaffecter({{$module->id}}, '{{$module->name}}')">
...
@endforeach
    ...
    <div id="affecterpopupfor{{$module->id}}" class="overlay">
        <div class="popup bg-white rounded-3 p-4 shadow-lg" style="max-width: 650px;">
            <form action="{{url('chef/modules_vacantes/affecter/'. $module->id)}}" method="post">
                @csrf
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h5 class="text-primary fw-bold mb-0">Affecter le module</h5>
                    <button type="button" class="btn-close" onclick="closePopupaffecter({{$module->id}})"></button>
                </div>
                
                <div class="mb-4">
                    <div class="d-flex align-items-center">
                        <div class="bg-primary bg-opacity-10 p-3 rounded-circle me-3 ">
                        <i class="bi bi-book fs-2" style="color: white !important;"></i>
                        </div>
                        <h6 class="mb-0 fw-bold" id="affectermoduleName{{$module->id}}">{{ $module->name }}</h6>
                    </div>
                </div>
                
                <!-- Select Professor -->
                <div class="mb-4">
                    <label for="professor" class="form-label fw-bold">Professeurs</label>
                ...
                <div class="d-flex justify-content-center gap-2 mt-4">
                    <button type="button" class="btn btn-outline-secondary px-4" onclick="closePopupaffecter({{$module->id}})">Annuler</button>
                    <button type="submit" class="btn btn-primary px-4">Affecter</button>
                </div>
            </form>
        </div>
    </div>
