                            ...
                            @foreach($assignement as $assign)
                                <div class="module-card">
                                    <div class="module-header">
                                        ...
                                        <div class="module-workload">
                                            ...
                                            <div class="workload-item">
                                                ...
                                                <span class="workload-value">{{ $assign->module->cm_hours }}h</span>
                                            </div>
                                            @endif
                                            ...
                                            <div class="workload-item">
                                                ...
                                                <span class="workload-value">{{ $assign->module->td_hours }}h</span>
                                            </div>
                                            @endif
                                            ...
                                            <div class="workload-item">
                                                ...
                                                <span class="workload-value">{{ $assign->module->tp_hours }}h</span>
                                            </div>
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <div class="module-details">
                                        <div class="detail-item">
                                            ...
                                            <div>
                                                ...
                                                <span class="detail-value">{{ $assign->module->filiere->name ?? 'N/A' }}</span>
                                            </div>
                                        </div>
                                        <div class="detail-item">
                                    ...
                                    <div class="module-actions">
                                        <button class="remove-btn" data-toggle="modal" data-target="#removemoduleId{{ $assign->id }}">
                                ...
                                <!-- Remove Modal -->
                                <div class="modal fade" id="removemoduleId{{ $assign->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <p style="color: #585858">Vous voulez remover le module <strong>{{ $assign->module->name }}</strong> de le professeur <strong>{{ $user->firstname }} {{ $user->lastname }}</strong> ?</p>
                                                <form action="{{ url('/chef/professeurs/remove/' . $assign->id) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
                            ...
                            <div class="module-card" draggable="true" data-module-id="{{ $module->id }}" ondragstart="dragStart(event)">
                                ...
                                <div class="module-details">
                                    <div class="detail-item">
                                        ...
                                        <div>
                                            <span class="detail-label">Filière</span>
                                            <span class="detail-value">{{ $module->filiere ? $module->filiere->name  : 'N/A' }}</span>
                                        </div>
                                    </div>
                                    <div class="detail-item">
                                        <i class="bi bi-calendar-week detail-icon"></i>
