                ...
                <table class="table table-borderless">
                    ...
                    <tbody>
                        @forelse ($module_requests->where('status', 'pending') as $module_request)
                                    ...
                                    <div class="custom-row-wrapper" style="width: 100%">
                                        <div class="custom-row d-flex" style="width: 100%">
                                            ...
                                            <div class="pAlso d-flex align-items-center gap-2">
                                                ...
                                                <button class="btn ml-1 btn-danger btn-sm" data-toggle="modal" data-target="#AnullerModal{{ $module_request['id'] }}"><i class="bi bi-x-square"></i></button>
                                            </div>
                                        </div>
                                    </div>
                                </td>
                            ...
                            <!-- Reject Modal -->
                            <div class="modal fade" id="AnullerModal{{ $module_request['id'] }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <p>Vous voulez annuler la demande de <strong>{{ $module_request->module->name}}</strong> ?</p>
                                            <form action="{{ route('professor.cancelRequest',$module_request['id']) }}" method="POST">
                                                @csrf
                                                @method('PATCH')
                                                <div class="modal-footer">
                                                    <button type="button" class="btn ml-1 btn-secondary btn-sm" data-dismiss="modal">Reteur</button>
                                                    <button type="submit" class="btn ml-1 btn-danger btn-sm">Anuller</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
