                      ...
                      <tr>
                            ...
                            <td>
                                <div  class="d-flex  justify-content-center align-items-center gap-2" >
                                        ...
                                        <a href="{{url('profile/'. $professor->id)}}" class="btn  btn-sm" style="background-color:#4723d9;color: #ffffff;"><i class="bi bi-pencil-square"></i></a>
