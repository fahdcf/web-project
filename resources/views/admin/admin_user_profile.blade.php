    ...
    <div class="container-fluid p-0 py-5 d-flex justify-content-center">
        <div class="profile-container d-flex flex-column">
            ...
            <div class="picture-container mt-5 d-flex align-items-center">
                ...
                <img style="height: 80px;width: 80px;object-fit:cover;border-radius:15%; border: 2px solid #1e0a6e;" src="{{asset('storage/' . $user->user_details->profile_img)}}">
                @else
                ...
                <div class="p-3">
                    <p style="color: rgb(29, 29, 29); font-weight:600">{{$user->firstname}} {{$user->lastname}}</p>
                   <!-- Changer Button -->
                ...
                <label for="lastname" class="form-label">Nom</label>
                    ...
                    <div class="col-md-6 col-lg-4 mb-3">
                        ...
                        <select class="form-select" id="statusFilter" name="status"  style="color:rgb(126, 124, 140) ">
                            ...
                            @if (!(optional($user->user_details)->status))
                            <option value="active">Active</option>
                            <option value="inactive">Inactive</option>
                           
                            @else

                            <option value="">{{optional($user->user_details)->status}}</option>

                            @if (optional($user->user_details)->status=='active')
    ...
    <section id="informations" class="hidden mt-5">
        ...
        <div class="col-md-6  mb-3">
            <label for="date" class="form-label">Date de Naissance</label>
                    <input type="date" id="date" name="date" class="form-control" value="{{optional($user->user_details)->date_of_birth}}">
                </div>


                <div class="col-md-6 mb-3">
                    <label for="adresse" class="form-label">Address</label>
                            <input type="text" id="adresse" name="adresse" class="form-control" value="{{optional($user->user_details)->adresse}}" placeholder="Votre adress..">
                        </div>
        
             
                        <div class="col-md-6 mb-3">
                            <label for="tele" class="form-label">Telephone</label>
                                    <input type="number" id="tele" name="tele" class="form-control" value="{{optional($user->user_details)->number}}" placeholder="numero de telephone..">
                                </div>
                
                     
                                <div class="col-md-6 mb-3">
                                    <label for="cin" class="form-label">CIN</label>
                                            <input type="text" id="cin" name="cin" class="form-control" value="{{optional($user->user_details)->cin}}" placeholder="numero de carte nationale..">
                                        </div>
                                        ...
                                        <div class="col-md-12 col-lg-12 mb-3">
                                            ...
                                            <div class="sex-group d-flex gap-4 mt-1">
                                                ...
                                                <label class="sex-label">
                                                  <input type="radio" name="sexe" value="male" class="sex-input" {{optional($user->user_details)->sexe ==='male'? 'checked' : ''}} />
                                                  <span class="sex-circle"></span>
                                                  Homme
                                                </label>
                                              
                                                <label class="sex-label">
                                                  <input type="radio" name="sexe" value="female" class="sex-input" {{optional($user->user_details)->sexe ==='female'? 'checked' : ''}}/>
                                                  <span class="sex-circle"></span>
                                                  Femme
                                                </label>
                                              </div>
...
<div class="pl-4">
     ...
     @if (optional($user->role)->isprof)
        professeur,
     @endif

     @if (optional($user->role)->isadmin)
     admin,
  @endif
   @if (optional($user->role)->isstudent)
  student,
@endif
 @if (optional($user->role)->iscoordonnateur)
 coordonnateur,
@endif

@if (optional($user->role)->ischef)
chef de departement
@endif
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <form action="{{url('/profile/modifier-image/'.$user->id)}}" method="post" enctype="multipart/form-data">
                @csrf
