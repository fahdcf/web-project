            ...
            <form action="{{ url('professeurs/add') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mt-3">
                    <div class="col-md-6 mb-4">
                        <label style="color: #515151; font-weight: 700" for="firstname" class="form-label fw-bold">
                            Prenom
                        </label>
                        <input
                            type="text"
                    ...
                    <!-- professeur lastName -->
                    <div class="col-md-6 mb-4">
                        <label style="color: #515151; font-weight: 700" for="lastname" class="form-label fw-bold">
                            Nom
                        </label>
                    ...
                    <div class="col-md-6 mb-4">
                        <label style="color: #515151; font-weight: 700" for="email" class="form-label fw-bold">
                            Email
                        </label>
                    ...
                    <!-- professeur modepass -->
                    <div class="col-md-6 mb-4">
                        <label style="color: #515151; font-weight: 700" for="password" class="form-label fw-bold">
                            Mot de passe
                        </label>
                        <input
                            type="text"
                    ...
                    <div class="col-md-6 mb-4">
                        <label style="color: #515151; font-weight: 700" for="status" class="form-label fw-bold">
                            Status
                        </label>
                    ...
                    <!-- professeur hours -->
                    <div class="col-md-6 mb-4">
                        <label style="color: #515151; font-weight: 700" for="hours" class="form-label fw-bold">
                            Charge horaire
                        </label>
                        <input
                            type="number"
                    ...
                    <!-- professeur profile -->
                    <div class="col-md-6 mb-4">
                        <label style="color: #515151; font-weight: 700" for="profile_img" class="form-label fw-bold">
                            Photo de profile
                        </label>
                                ...
                                <div class="accordion-body">
                                    <div class="row mt-3">
                                        <div class="col-md-6 col-lg-4 mb-3">
                                            <label
                                                style="color: #515151; font-weight: 700"
                                                for="date"
                                                class="form-label">
                                                Date de Naissance
                                            </label>
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-3">
                                            ...
                                            <input
                                                ...
                                                name="cin"
                                                class="form-control"
                                                placeholder="numero de carte nationale.." />
                                        </div>
