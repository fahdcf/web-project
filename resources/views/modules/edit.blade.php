    ...
    <div class="container-fluid py-4">
        <form action="{{ route('coordonnateur.modules.update', $module->id) }}" method="POST"
            ...
            <div class="form-header mb-4 bg-primary text-white p-3 rounded">
                <h4 class="mb-0"><i class="fas fa-edit me-2"></i>Modifier l'UE: {{ $module->name }}</h4>
                <small class="text-white-50">Filière: {{ $filiere->name ?? 'Non définie' }} - Année universitaire:
                    {{ $anneeUniversitaire ?? now()->year }}</small>
            </div>
                ...
                <div class="row g-3">
                    <div class="col-md-4">
                        ...
                        <select name="type" id="type" class="form-select @error('type') is-invalid @enderror"
                            ...
                            <option value="complet" {{ old('type', $module->type) == 'complet' ? 'selected' : '' }}>
                                Complet</option>
                            <option value="element" {{ old('type', $module->type) == 'element' ? 'selected' : '' }}>
                                Élément</option>
                        </select>
                        @error('type')
                    ...
                    <div class="col-md-8">
                        ...
                        <input type="text" name="name" id="name"
                            ...
                            placeholder="Ex: Programmation Web Avancée" value="{{ old('name', $module->name) }}">
                        @error('name')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 d-flex align-items-end">
                        <div class="alert alert-info p-2 mb-0 w-100">
                            <small>
                                ...
                                Si vous souhaitez changer le module parent, sélectionnez-en un nouveau.
                            </small>
                        </div>
                    </div>
                </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        <div class="alert alert-info py-2 d-flex justify-content-between align-items-center">
                            ...
                            <span id="total_hours"
                                class="badge bg-primary rounded-pill">{{ $module->cm_hours + $module->td_hours + $module->tp_hours + $module->autre_hours }}</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="form-section mb-4">
                <h3 class="section-title h5 mb-3 fw-bold border-bottom pb-2 text-primary">
                    <i class="fas fa-user-tie me-2"></i>Responsable du module et Status*
                </h3>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="status" id="status"
                            ...
                            <option value="active" {{ old('status', $module->status) == 'active' ? 'selected' : '' }}>
                                Active</option>
                            <option value="inactive" {{ old('status', $module->status) == 'inactive' ? 'selected' : '' }}>
                                Inactive</option>
                        </select>
                        @error('status')
                            <div class="invalid-feedback">{{ $message }}</div>
