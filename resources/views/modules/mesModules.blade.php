        ...
        <div class="header-container mb-4">
            ...
            <div class="header-grid mt">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <h3 style="color: #330bcf; font-weight: 500;">Mes Unitee d'Enseignements :</h3>
                </div>

                <a href="{{ route('availableModules') }}" class="btn btn-primary rounded fw-semibold my-2 me-2">
                    voir les UE disponible
                </a>
            </div>
        </div>
