<x-coordonnateur_layout>
    <div class="container-fluid px-4 py-4">
        ...
        <div class="border d-flex justify-content-between align-items-center mb-4 py-3 border-bottom">
            <div >
                <div >
                    ...
                    <h1 class="h3 text-gray-800 border"><i class="fas fa-book-open me-2 text-primary"></i> des Unités d'Enseignement</h1>
                    ...
                    <div class="row g-3 align-items-center">
                        <div class="col-md-4">
                            ...
                            <select class="form-select form-select-sm" name="filterSemester" id="filterSemester">
                                ...
                                @for($i = 1; $i <= 6; $i++)
                                <option value="{{ $i }}" {{ request('filterSemester') == $i ? 'selected' : '' }}>Semestre {{ $i }}</option>
                                @endfor
                            </select>
                        </div>
                    ...
                    <table class="table table-hover align-middle mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="badge rounded-pill @if($module->status === 'active') bg-success @else bg-danger @endif">
                                        <i class="fas @if($module->status === 'active') fa-check-circle @else fa-times-circle @endif me-1"></i>
                                        {{ $module->status ? 'active' : 'inactive' }}
                                    </span>
                                </td>
                                <td class="text-end">
        ...
        <div class="modal fade" id="assignVacataireModal" tabindex="-1" aria-labelledby="assignVacataireModalLabel" aria-hidden="true">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="vacataire_id" id="vacataire_id" required>
                                    ...
                                    <option value="{{ $vacataire->id }}">
                                        {{ $vacataire->lastname }} {{ $vacataire->firstname }} ({{ $vacataire->specialty }})
                                    </option>
                                    @endforeach
                                </select>
                            </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            function applyFilters() {
                ...
                $('.card').each(function() {
                    const card = $(this);
                    const semesterMatch = semester === 'all' || card.find('tbody tr').data('semester') == semester;
