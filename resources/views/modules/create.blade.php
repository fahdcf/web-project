<x-coordonnateur_layout>
    ...
    <!-- Form Section -->
    <form action="{{ route('coordonnateur.modules.store') }}" method="POST" class="module-form bg-white rounded-3 shadow">
        @csrf
                ...
                <div class="row g-4">
                    <div class="col-md-12">
                        ...
                        <select name="responsable_id" id="responsable_id"
                            ...
                            <option value="" disabled>Sélectionner un professeur responsable</option>
