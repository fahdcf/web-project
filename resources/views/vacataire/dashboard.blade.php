            ...
            <section class="main-section col-12 col-md-8 col-lg-9 p-0 pr-md-4">
                <div class="welcome p-4">
                    <div class="d-flex flex-column justify-content-between col-8">
                        ...
                        <p style="font-size: 14px;">Consultez votre emploi du temps et gérez vos cours assignés.</p>
                    ...
                    <div class="p-2 col-6 col-lg-4">
                        <div class="numbers-card bg-white d-flex p-2 gap-3 gap-md-4 align-items-center">
                            ...
                            <div class="d-flex flex-column justify-content-start align-items-start">
                                <p class="title">Cours assignés</p>
                                <p class="num">Total: <strong>{{ $totalCourses ?? 3 }}</strong></p>
                    ...
                    <div class="p-2 col-6 col-lg-4">
                        <div class="numbers-card bg-white d-flex p-2 gap-3 gap-md-4 align-items-center">
                            ...
                            <div class="d-flex flex-column justify-content-start align-items-start">
                                ...
                                <p class="num">En attente: <strong>{{ $pendingGrades ?? 2 }}</strong></p>
                                <a href="#" class="seemore">> Voir Plus</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-2 col-6 col-lg-4">
                        <div class="numbers-card bg-white d-flex p-2 gap-3 gap-md-4 align-items-center">
                            ...
                            <div class="d-flex flex-column justify-content-start align-items-start">
                                ...
                                <p class="num">Cette semaine: <strong>{{ $upcomingClasses ?? 3 }}</strong></p>
                        ...
                        @empty
                            <div class="class-item mt-3 d-flex justify-content-between align-items-center pb-3">
                                <div class="d-flex gap-3 align-items-center">
                                    <i style="color: #4723d9" class="bi bi-book-fill"></i>
                                    <div>
                                        <p class="class-desc m-0"><strong>Programmation</strong> - Salle C01</p>
                                        <p class="class-time m-0">Lundi, 10:00 - 12:00</p>
                                    </div>
                                </div>
                                <a href="{{ route('emploi.myTimetable') }}"><i
                                        class="bi bi-arrow-right-circle-fill"></i></a>
                            ...
                            <div class="class-item mt-3 d-flex justify-content-between align-items-center pb-3">
                                <div class="d-flex gap-3 align-items-center">
                                    <i style="color: #4723d9" class="bi bi-book-fill"></i>
                                    <div>
                                        <p class="class-desc m-0"><strong>Bases de Données</strong> - Salle D02</p>
                                        <p class="class-time m-0">Mercredi, 14:00 - 16:00</p>
                                    </div>
                                </div>
                                <a href="{{ route('emploi.myTimetable') }}"><i
                                        class="bi bi-arrow-right-circle-fill"></i></a>
                        ...
                        @empty
                            <div class="course-item mt-3 d-flex justify-content-between align-items-center pb-3">
                                <div class="d-flex gap-3 align-items-center">
                                    <i style="color: #4723d9" class="bi bi-book-fill"></i>
                                    <div>
                                        <p class="course-desc m-0">Programmation</p>
                                        <p class="course-time m-0">S3 - Groupe A</p>
                                    </div>
                                </div>
                                <div class="dropdown">
                                    <button data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <div class="course-item mt-3 d-flex justify-content-between align-items-center pb-3">
                                <div class="d-flex gap-3 align-items-center">
                                    <i style="color: #4723d9" class="bi bi-book-fill"></i>
                                    <div>
                                        <p class="course-desc m-0">Bases de Données</p>
                                        <p class="course-time m-0">S3 - Groupe B</p>
                                    </div>
                                </div>
                                <div class="dropdown">
                                    <button data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    <div class="task-content p-3 p-md-4 pt-0">
                        ...
                        <div class="task-item mt-3 d-flex justify-content-between align-items-center pb-3">
                            <div class="d-flex gap-3 align-items-center">
                                ...
                                <div>
                                    <p class="task-desc m-0">Saisir les notes de Programmation</p>
                                    <p class="task-time m-0">Date limite: 10/06/2025</p>
                                </div>
                            </div>
                        ...
                        <div class="task-item mt-3 d-flex justify-content-between align-items-center pb-3">
                            <div class="d-flex gap-3 align-items-center">
                                ...
                                <div>
                                    <p class="task-desc m-0">Préparer le TP de Bases de Données</p>
